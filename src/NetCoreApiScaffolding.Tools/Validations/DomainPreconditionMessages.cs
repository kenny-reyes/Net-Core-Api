...
namespace NetCoreApiScaffolding.Tools.Validations
{
    public static class DomainPreconditionMessages
    {
        ...
        public static string GetSuccessMatch(string parameterName, string entityName) => $"'{parameterName}' must be valid at {entityName}.";
        ...
        public static string IsInTheList(string parameterName) => $"{parameterName} must be valid.";
        public static string IsDoubleOf(string parameterName) => $"{parameterName} must be a double.";
    }
}
